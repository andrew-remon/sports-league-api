...
def get_standings(league_id):
    ...
    home_won_sq = home_matches.filter(result__home_score__gt=F('result__away_score')).values('home_team').annotate(c=Count('pk')).values('c')
    home_drawn_sq = home_matches.filter(result__home_score=F('result__away_score')).values('home_team').annotate(c=Count('pk')).values('c')
    ...
    away_won_sq = away_matches.filter(result__away_score__gt=F('result__home_score')).values('away_team').annotate(c=Count('pk')).values('c')
    away_drawn_sq = away_matches.filter(result__away_score=F('result__home_score')).values('away_team').annotate(c=Count('pk')).values('c')
