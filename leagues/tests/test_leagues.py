...
def test_list_league(api_client, sample_league):
    premier_league = sample_league(name='Premier League', max_teams=20)
    la_liga = sample_league(name='La Liga', max_teams=20)
    bundesliga = sample_league(name='Bundesliga', max_teams=18)
